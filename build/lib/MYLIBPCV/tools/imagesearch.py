...
class Indexer(object):
    ...
    def create_tables(self):
        ...
        self.con.execute('create index wordid_idx on imowrds(wordid)')
        self.con.execute('create index imid_idx on imwords(imid)')
        self.con.execute('create index imidhist_idx on histograms(imid)')
        self.db_commit()
    ...
    def add_to_index(self,imname,descr):
        ...
        self.con.execute("insert into imhistograms(imid,histogram,vocname) \
                        values (?,?,?)", (imid,pickle.dumps(imwords), \
                                          self.voc.name))
